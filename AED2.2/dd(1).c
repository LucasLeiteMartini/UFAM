...
/// @brief verifica o nível de agrupamento da tabela
/// @param dd 
/// @return a medida de agrupamento, segundo momento do tamanho das listas.
...
static void rehashing_dd(t_dd* dd){
    ...
    printf("---Rehashing carga: %.2lf %.3lf\n", carga, C);
...
t_dd* criar_dd(){
    ...
    t_dd* novo = internal_criar_dd(M, fc);
